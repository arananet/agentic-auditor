...
export class TechnicalAudit implements IAuditStrategy {
  ...
  async execute({ $, html, baseUrl }: AuditContext): Promise<AuditResult> {
    ...
    let finalScore = Math.max(0, Math.min(100, csrScore + robotsScore + metaPenalty));
